...
bool Dictionary::getYearsFromWord( QueryResult& query_r , const QString& word )
{
...
bool Dictionary::getCategorieFromWord( QueryResult& query_r , const QString& word )
{
